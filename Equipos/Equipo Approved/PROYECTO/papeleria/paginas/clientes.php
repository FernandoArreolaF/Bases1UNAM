        ...
        <div class="h1 text-center font-weight-bold"><br />Clientes</div>
            <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post"> 
                ...
                <div class="col-1"></div>
                    ...
                    <div class="col-2">
                        <input type="submit" value="Borrar Cliente" name="delete" class="btn btn-danger">
                    </div>
                </div>
            </form>
            ...
            <?php
                function insertFunc(){
                    echo "<div class='formulario'>";
                        ...
                        echo "<form action='../php/agregar-cliente.php' method='post' class='form-registro'>";
                            ...
                            echo"<input type='text' name='razon' placeholder='Código de Cliente' class='form-input' required>";
                ...
                function updateFunc(){
                    echo "<div class='formulario'>";
                        echo"<link rel='stylesheet' href='../css/formulario-registro.css'>";
                        echo "<form action='../php/modificar-cliente.php' method='post' class='form-registro'>";
                            echo"<h2 class='form-titulo'>Actualizar Cliente</h2>";
                            echo"<div class='form-group row'>";
                                echo"<label for='razon' class='col-sm-3 col-form-label'>Código Cliente</label>";
                                echo"<div class='col-sm-9'>";
                                    echo"<input type='text' class='form-control' name='razon' placeholder='Código Cliente'>";
                                echo"</div>";
                            echo"</div>";
                            echo"<div class='form-group row'>";
                                echo"<label for='opcion' class='col-sm-3 col-form-label'>Dato a cambiar</label>";
                                echo"<select class='form-control col-sm-4 col-form-label' id='opcion' name='opcion'>";
                ...
                function deleteFunc(){
                    echo "<div class='formulario'>";
                        echo "<form action='../php/borrar-cliente.php' method='post' class='form-registro'>";
                            ...
                            echo"<br />";
                            echo"<div class='inputs'>";
                                echo"<input type='text' name='razon' placeholder='Ingresa el código del Cliente a borrar'  class='form-input' required>";
