...
<head>
    ...
    <link rel="stylesheet" href="css/estilos7_2.css"> 
...
<body>
    <section class="form_add">
        <form action="" class="form_data" method="post" autocomplete="off">
            ...
            <div class="Client-info2">
                <input class="inputs" type="text" name="tl1" placeholder="# Telefono 10 dígitos">
            </div>
            <div class="Client-info1">
                <label for="tL2">Telefono 2</label>
            </div>
            <div class="Client-info2">
                <input class="inputs" type="text" name="tl2" placeholder="# Telefono 10 dígitos">
            </div>
            <div class="Client-info1">
                <label for="tL3">Telefono 3</label>
            </div>
            <div class="Client-info2">
                <input class="inputs" type="text" name="tl3" placeholder="# Telefono 10 dígitos">
            </div>
            <div class="Client-info3">
            ...
            <div class="Btn-Options">
                ...
                <center><input type="submit" value="Regresar a añadir Producto" id="btnCancel" name="exiT"></center>
            </div>
        </form>
    </section>
    <footer>
